...
standard deviation for all of the data that it collects --- you and your partner should add in extra calls to the
{\tt public static double calculateStandardDeviation(Long[] timings)} in every location where you think it is needed.
