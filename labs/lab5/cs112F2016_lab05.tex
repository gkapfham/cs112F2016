...
\begin{document} \MYTITLE{Laboratory Assignment Five: Studying the Efficiency of Incremental String Building}
\MYHEADERS{Laboratory Assignment Five}{Due: October 17, 2016}
