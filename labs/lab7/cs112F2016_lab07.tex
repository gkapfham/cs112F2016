...
\begin{sloppypar} To start this laboratory assignment, you should return to the {\tt cs112F2016-share} Git repository
  ...
  command ``{\tt ant compile}'' in a terminal and it will compile the three Java classes and save the bytecode in the
