\input{111pre}
\begin{document}
\MYTITLE{Exam 2 Study Guide \\ Delivered: Monday, November 21, 2016 \\ Exam 2: Thursday, December 1, 2016, 9:30 am}
...
\begin{itemize}
  ...
  \item All prior chapters covered for the first examination

  \item Chapter Three in DSAAJ, only Section 3.2 --- 3.6  (i.e., ``Linked Lists'')

  \item Chapter Six in DSAAJ, skipping Section 4.4 (i.e., ``Stacks, Queues, and Deques'')

  \item Chapter Seven in DSAAJ, skipping Section 5.6 (i.e., ``Lists and Iterators'')
